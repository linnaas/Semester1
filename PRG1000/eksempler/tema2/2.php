...
else if($svar == "j" || $svar == "ja"){ // "if" Funskjon som sjekker om svaret brukeren skrev inn er "ja" eller "j"
print("Du er student");// Denne koden utføres dersom påstanden i "if" funksjonen er riktig.
}
else if ($svar == "n" || $svar == "nei"){// "if" Funskjon som sjekker om svaret brukeren skrev inn er "nei eller "n"
